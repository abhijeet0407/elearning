...
<body id="page-top">
    ...
    <h2>Video Log</h2>
    <?php $vids=array('Creation of Specifier','Project Creation & Entering of product details','Quotation Creation and editing of quotation','Order Creation & Schedule Supply') ?>
