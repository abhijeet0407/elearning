...
.alert-danger{ background-color: rgba(255,255,255,0.5); font-weight: bold; border:1px solid #fff; font-size: 15px; }
...
<script src="https://www.hrjohnsonindia.com/elearning/public/bootstrap-growl/bootstrap-growl.min.js"></script>
                ...
                $.ajax({
                  ...
                  .done(function(data) {
                    ...
                    if(data==1){
                      ...
                      swal({
                            title:"",
                            text:"The provided email address is not registered with us. Please provide registered email address",
                            type: "error",
                            confirmButtonText:"OK"
